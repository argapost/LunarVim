local highlights = {
  ...
  Folded = { fg = C.dark_gray, bg = "none"},
  FoldColumn = { fg = "none", bg = "none" },
  LineNr = { fg = C.dark_gray },
  FloatBoder = { fg = C.dark_gray, bg = "none" },
  Whitespace = { fg = C.bg },
  VertSplit = { fg=C.dark_gray, bg = "NONE", style="NONE" },
  ...
  TabLine = { fg = C.light_gray, bg = "none" },
